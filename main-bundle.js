(() => {
  ...
  var c = function (n, e, t, r, o, i) {
      for (var a = 0; a < e.length; a++)
        for (var c = 0; c < e[0].length; c++)
          if (e[a][c] > 0) {
            var u = e[a][c];
            (n.fillStyle = i(n, u, c, a, e)),
              n.fillRect((t + c) * o, (r + a) * o, o, o);
          }
    },
    u = function (n, e, t, r) {
      (n.font = ''.concat(e, 'px ').concat(t)),
        (n.fillStyle = r || n.fillStyle);
    },
    l = function (n, e, t, r) {
      n.fillText(e, t, r);
    },
    ...
    f = {
      ...
      emitEvent: function (n, e) {
        if (this.keyDownListeners[n])
          for (
            var t = this.keyDownListeners[n].map(function (n) {
                return [n(e), n];
              }),
              r = 0,
              o = t;
      ...
      keyDown: function (n) {
        var e = this;
        return n === this.ANY
          ? Object.keys(this.keys).some(function (n) {
              return !0 === e.keys[n];
            })
      ...
      onKeyDown: function (n, e) {
        ...
        return (
          (n = n.toLowerCase()),
          this.keyDownListeners[n] || (this.keyDownListeners[n] = []),
          this.keyDownListeners[n].push(e),
          function () {
  ...
  var p,
    ...
    d = function (n, e) {
      for (var t, r = 0; r < n.length; ++r)
        for (var o = 0; o < r; ++o)
          (t = [n[r][o], n[o][r]]), (n[o][r] = t[0]), (n[r][o] = t[1]);
      e > 0
          ...
          for (var e = 0; e < n.player.shape.length; e++)
            for (var t = 0; t < n.player.shape[e].length; t++)
              if (0 !== n.player.shape[e][t]) {
                ...
                void 0 !== n.arena[r] &&
                  void 0 !== n.arena[r][o] &&
                  (n.arena[r][o] = n.player.shape[e][t]);
              }
        })(n),
        (n.player = g(n.bag)),
        e && (n.score += a.scorePoints.LANDING);
    },
    E = function (n) {
      for (var e = 0; e < n.player.shape.length; e++)
        for (var t = 0; t < n.player.shape[e].length; t++)
    ...
    O = function (n) {
      return function (e, t) {
        return new Promise(function (r) {
          var o;
          T(n)
            ? chrome.storage[n].set((((o = {})[e] = t), o), r)
            : (D(e, t), r());
        });
      };
    },
    _ = function (n) {
      return function (e) {
        return new Promise(function (t, r) {
          ...
          if (T(n))
            chrome.storage[n].get(e, function (n) {
        ...
        H(void 0, void 0, void 0, function () {
          ...
          return M(this, function (d) {
            switch (d.label) {
              case 0:
                return (
                  (A = a.analytics.GA_ENDPOINT),
                  (E = a.analytics.GA_MEASUREMENT_ID),
                  (S = a.analytics.GA_API_SECRET),
                  (t = ''
                    .concat(A, '?measurement_id=')
                    .concat(E, '&api_secret=')
                    .concat(S)),
                  (r = fetch),
                  (o = [t]),
                  ...
                  [
                    4,
                    ((w = a.storageKeys.localStorage.GA_CLIENT_ID),
                    I(w).catch(function () {
              ...
              case 1:
                return (
                  ...
                  [
                    4,
                    ((g = a.storageKeys.chromeStorage.GA_USER_ID),
                    N(g).catch(function () {
                      var n = self.crypto.randomUUID();
                      return R(g, n), n;
                    })),
                    ...
                    H(void 0, void 0, void 0, function () {
                      ...
                      return M(this, function (r) {
                        switch (r.label) {
                          case 0:
                            return (
                              (n = a.analytics.GA_SESSION_EXPIRATION_IN_MIN),
                              [
                                4,
                                I(
                                  a.storageKeys.localStorage.GA_SESSION_DATA
                                ).catch(function () {
                                  return {
                                    timeStamp: Date.now(),
                                    sessionId: Date.now(),
                          ...
                          case 1:
                            return (
                              (e = r.sent()),
                              (t = Date.now() - e.timeStamp),
                              n < t / 6e4 && (e.sessionId = Date.now()),
                  ...
                  return (function (n, e) {
                    ...
                    switch (u.label) {
                      ...
                      case 1:
                        return (
                          u.trys.push([1, 4, 5, 6]),
                          (a = n.apply(void 0, e)) instanceof Promise
                            ? [
                                4,
                                a.catch(function (n) {
                                  return i(n);
  ...
  var j = function (n, e) {
    ...
    z = function (n, e) {
      ...
      (n.paused = e),
        (r = e ? 'play' : 'pause'),
        ((t = W('button#pause')).querySelector('img').src = 'assets/'.concat(
          r,
          '.png'
        )),
        t.blur();
          ...
          return (function (n, e) {
            ...
            return (
              ...
              e.paused ||
                ...
                t.dropCounter > a.DROP_INTERVAL
                  ? ((e.player.y += 1),
                    (i = w(e)) ? (t.lockCounter += b(t)) : (t.dropCounter = 0),
                    i && t.lockCounter > a.LOCK_DELAY && A(e))
                  : (t.lockCounter = 0),
                t.dropCounter > a.DROP_KEY_INTERVAL &&
                  ...
                  (function (n) {
                    return (
                      (n.player.y += 1),
                      (n.score += a.scorePoints.DROP),
                      !w(n) || ((n.score -= a.scorePoints.DROP), !1)
                    );
                  })(e) || ((e.score += a.scorePoints.LANDING), A(e))),
                t.horizontalMovementCounter > a.HORIZONTAL_MOVEMENT_INTERVAL &&
                  ((t.horizontalMovementCounter = 0),
                  (f = e.player.x),
                  h.keysDown.apply(h, a.controls.RIGHT)
                    ? (e.player.x += 1)
                    : h.keysDown.apply(h, a.controls.LEFT) && (e.player.x -= 1),
                  E(e) && (e.player.x = f)),
                e.arena.filter(P).forEach(function (n, t) {
                  var r, o;
                  (r = e.arena),
                    (o = e.arena.indexOf(n)),
                    r.splice(o, 1),
                    r.unshift(Array(a.ARENA_WIDTH).fill(0)),
                    (e.score += a.scorePoints.LINECLEAR * Math.pow(2, t));
                })),
              e.lost &&
                h.keyDown(h.ANY) &&
                !e.isReloading &&
                ((e.isReloading = !0), r()),
              !e.lost &&
                ((v = e.arena), v.slice(0, 3)).some(x) &&
                ((e.lost = !0),
                (e.player = o),
                ((y = e.player).shape = y.shape.map(function (n) {
              ...
              e.score > e.highScore &&
                ((e.highScore = e.score),
                (d = e.highScore),
                k(a.storageKeys.chromeStorage.HIGHSCORE, d)),
              C(e),
              (function (n) {
                (n.fillStyle = '#000000'),
              ...
              c(n, e.arena, 0, 0, a.SCALE, V),
              (n.strokeStyle = '#FF0000'),
              (n.lineWidth = 2),
              (function (n, e, t, r, o) {
                n.beginPath(), n.moveTo(0, t), n.lineTo(r, o), n.stroke();
              })(n, 0, 3 * a.SCALE, a.ARENA_WIDTH * a.SCALE, 3 * a.SCALE),
              (n.globalAlpha = Math.max(
                1 - t.lockCounter / a.LOCK_DELAY,
                t.lockCounter / a.LOCK_DELAY
              )),
              c(n, e.player.shape, e.player.x, e.player.y, a.SCALE, V),
              (n.globalAlpha = 1),
              (function (n, e) {
                u(n, s, a.font.FAMILY, a.font.COLOR),
                  (n.textBaseline = 'middle'),
                  (n.textAlign = 'center');
                for (
                  var t = ''.concat(e);
                  n.measureText(t).width > 5.5 * a.SCALE;

                )
                  u(n, (s -= 1), a.font.FAMILY, a.font.COLOR);
                l(n, t, a.SCALE * (a.ARENA_WIDTH / 2), 1.75 * a.SCALE);
              })(n, e.score),
              (function (n, e) {
                u(n, 0.6 * a.SCALE, a.font.FAMILY, a.font.COLOR),
                  (n.textBaseline = 'middle'),
                  (n.textAlign = 'center'),
                  l(
                    n,
                    'High score: '.concat(e),
                    a.SCALE * (a.ARENA_WIDTH / 2),
                    4 * a.SCALE
                  );
              })(n, e.highScore),
    ...
    nn = function (n) {
      ...
      return e
        ? (q(e.querySelectorAll('[data-close]'), 'click', X),
          q(e.querySelectorAll('[data-analytics]'), 'click', Q),
          e)
        ...
        return rn(this, function (t) {
          return (
            ...
            $('tetrys')
              ...
              .then(function (n) {
                var e;
                return null === (e = document.querySelector('#ads')) ||
                  void 0 === e
                  ? void 0
                  : e.appendChild(n);
              })
        ...
        switch (r.label) {
          case 0:
            return (
              ...
              h.initialize(),
              (n = window.document.querySelector('canvas')),
              (e = n.getContext('2d')),
              [
                4,
                tn(void 0, void 0, void 0, function () {
                  var n, e;
                  return rn(this, function (t) {
                    switch (t.label) {
                      case 0:
                        return (
                          (n = L(a.storageKeys.localStorage.GAMESTATE)),
                          [
                            4,
                            I(a.storageKeys.chromeStorage.HIGHSCORE).catch(
                              o(0)
                            ),
                          ]
                        );
                      ...
                      switch (i.label) {
                        ...
                        case 2:
                          return (
                            (t = i.sent()),
                            (r = Math.max(e, t)),
                            R(a.storageKeys.chromeStorage.HIGHSCORE, r),
                            k(a.storageKeys.chromeStorage.HIGHSCORE, r),
                            n(r),
                            [2]
                          );
                      }
                  ...
                  h.onKeyStart(' ', function () {
                    return (
                      ...
                      (function (n) {
                        ...
                        --e > 0 && (n.score += e * a.scorePoints.HARDDROP),
                          A(n, !1);
                      })(e)
                    );
                  }),
